                        ...
                        <td class="py-3 px-6 text-center">
                            <div class="flex justify-center items-center gap-2">
                                <a href="{{ route('students.show', $student->id) }}"
                                    class="bg-blue-50 border border-blue-500 p-2 w-10 h-10 flex items-center justify-center text-blue-500">
                                    <i class="ph ph-eye"></i>
                                </a>
                                @can('edit-student')
                                    <a href="{{ route('students.edit', $student->id) }}"
                                        class="bg-yellow-50 border border-yellow-500 p-2 w-10 h-10 flex items-center justify-center text-yellow-500">
                                ...
                                @can('destroy-student')
                                    <form onsubmit="return confirm('Are you sure?')" method="POST"
                                        ...
                                        @csrf
                                        <button type="submit"
                                            class="bg-red-50 border border-red-500 p-2 w-10 h-10 flex items-center justify-center text-red-500">
