<x-auth-layout title="Register" section-title="Register" section-description="Register using your email">
    <form action="{{ route('auth.store') }}" method="POST" class="flex flex-col gap-4">
        ...
        <button type="submit"
            class="bg-blue-500 border text-white px-3 py-2 text-center gap-2 cursor-pointer">
            <span>Register</span>
        </button>
